...
const upload = require("../Node/reward_app/middlewares/multer.js");
const cloudinary = require("../node/reward_app/config/cloudinary.js");
...
app.post('/admin/login' ,async(req,res) => {
  try {
    ...
    if (response.status === 200 && response.data.success) {
      ...
      res.status(200).json({ success : true, message: 'Login successfull', token: response.data.token});
    } 
